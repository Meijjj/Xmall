     ...
     <div class="sku-custom-title">
      ...
      <div class="buy">
        <y-button text="加入购物车"
                  ...
                  classStyle="main-btn" style="width: 145px;height: 50px;line-height: 48px"></y-button>
        <y-button text="现在购买" @btnClick="checkout(product.productId)"
