        ...
        <ul class="common-form">
         ...
         <!--登陆-->
          <div style="margin-top: 25px">
            ...
            @btnClick="login" style="margin: 0;width: 100%;height: 48px;font-size: 18px;line-height: 48px">
            </y-button>
          </div>
...
import { geetest, userLogin } from '/api/index.js'
